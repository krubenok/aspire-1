...
internal interface IAspireSkillsBundleProvider
{
    ...
    /// <summary>
    /// Gets the archive asset name prefix used by bundles for the specified asset kind.
    /// </summary>
    string GetArchiveAssetNamePrefix(AgentAssetKind assetKind);
...
internal sealed class AspireSkillsBundleProvider : IAspireSkillsBundleProvider
{
    ...
    private static readonly BundleLayout s_skillsBundleLayout = new(
        ...
        archiveAssetNamePrefix: "aspire-skills",
    ...
    private static readonly BundleLayout s_extensionsBundleLayout = new(
        ...
        archiveAssetNamePrefix: "aspire-extensions",
    ...
    public string GetArchiveAssetNamePrefix(AgentAssetKind assetKind)
    {
        return GetBundleLayout(assetKind).ArchiveAssetNamePrefix;
    }
        ...
        Action<SkillBundleAsset, IReadOnlyList<string>>? validateAssetFiles = null)
    {
        ...
        public string ArchiveAssetNamePrefix { get; } = archiveAssetNamePrefix;
